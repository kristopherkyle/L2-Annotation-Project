...
| [dislocated](https://universaldependencies.org/u/dep/dislocated.html) | dislocated elements | steel_**dislocated** or iron , which use for our building , it_**head** can make it stronger and easy to destroy . | Limited examples in corpora | Limited examples in corpora |
...
| [punct](https://universaldependencies.org/u/dep/punct.html) | punctuation | The scene of Toyko is not beautiful_**head** ,_**punct** but you think that this city is a developing place ._**punct** | Limited examples in corpora | Limited examples in corpora |
...
| [root](https://universaldependencies.org/u/dep/root.html) | root | I could n't believe_**root** it but he gave me the contract ot fill it out . | Limited examples in corpora | Limited examples in corpora |
